...
| [`skills/gtm-swarm-data-poster`](skills/gtm-swarm-data-poster/) | Skill for posting `swarm.telemetry.v1` batches, artifacts, and observations to GTM Swarm. |
| [`skills/hunter-x-analytics-analysis`](skills/hunter-x-analytics-analysis/) | Skill for interpreting Hunter's X analytics and recommending growth-system changes. |
...
Focused data posting workflow from Boyuan's GTM Swarm contract:

- `swarm.telemetry.v1` batch validation
- artifact and observation payload shape
- `collect_daily_telemetry` result format
- GTM Swarm push commands

### `hunter-x-analytics-analysis`

Focused analysis workflow for Hunter's X metrics:

- candidate-set entry judgement
...
ln -s ~/code/agent-gtm/skills/gtm-swarm-data-poster ~/.claude/skills/gtm-swarm-data-poster
ln -s ~/code/agent-gtm/skills/hunter-x-analytics-analysis ~/.claude/skills/hunter-x-analytics-analysis
